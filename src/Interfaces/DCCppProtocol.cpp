...
void ConfigErase::process(const vector<string> arguments)
{
  configStore->clear();
...
void ConfigStore::process(const vector<string> arguments)
{
#if S88_ENABLED
...
void ReadCVCommand::process(const vector<string> arguments)
{
...
void WriteCVByteProgCommand::process(const vector<string> arguments)
{
  uint16_t cv = std::stoi(arguments[0]);
...
void WriteCVBitProgCommand::process(const vector<string> arguments)
{
...
void WriteCVByteOpsCommand::process(const vector<string> arguments)
{
...
void WriteCVBitOpsCommand::process(const vector<string> arguments)
{
...
void StatusCommand::process(const vector<string> arguments)
{
...
void FreeHeapCommand::process(const vector<string> arguments)
{
  wifiInterface.broadcast(StringPrintf("<f %d>", os_get_free_heap()));
}
...
void EStopCommand::process(const vector<string> arguments)
{
  locoManager->set_state(true);
}

DECLARE_DCC_PROTOCOL_COMMAND_CLASS(CurrentDrawCommand, "c")
void CurrentDrawCommand::process(const vector<string> arguments)
{
  trackSignal->broadcast_status();
}

DECLARE_DCC_PROTOCOL_COMMAND_CLASS(PowerOnCommand, "1")
void PowerOnCommand::process(const vector<string> arguments)
{
  trackSignal->enable_ops_output();
}

DECLARE_DCC_PROTOCOL_COMMAND_CLASS(PowerOffCommand, "0")
void PowerOffCommand::process(const vector<string> arguments)
{
